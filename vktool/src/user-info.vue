...
export default {
  ...
  methods: {
      ...
      filterFriendsGroups() {
        ...
        //     console.log('comparing max: ' + this.max + 'and group rate: ' + this.user.friendsGroups[group]);
        //     if (this.max >= this.user.friendsGroups[group]) {
        //         console.log('too low rate with group #' + group);
        //     } else if ( this.max < this.user.friendsGroups[group]) {
        //         this.max = this.user.friendsGroups[group]
        //         console.log('new max will be: ' + this.max);
        //     }
        // };
        this.analyzed = [];
        for (let group in this.user.friendsGroups) {
